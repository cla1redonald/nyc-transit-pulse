...
import type { TransitMode, DailyRidership } from '@/types/transit'
...
interface FilterContextValue extends FilterState {
  ...
  computeDateRange: (preset: DatePreset, customStart?: Date, customEnd?: Date) => DateRange
}
...
export function FilterProvider({ children }: { children: ReactNode }) {
  const [dateRange, setDateRange] = useState<DateRange>(computeInitialDateRange())
  const [activeModes, setActiveModes] = useState<Set<TransitMode>>(DEFAULT_ACTIVE_MODES)
