...
function getRidershipColor(ridership: number, minRidership: number, maxRidership: number): string {
...
function getRidershipRadius(ridership: number, minRidership: number, maxRidership: number): number {
  const minRadius = 4
  const maxRadius = 20
...
export function StationMarker({ station }: StationMarkerProps) {
  ...
  const color = getRidershipColor(station.avgDailyRidership, minRidership, maxRidership)
  const radius = getRidershipRadius(station.avgDailyRidership, minRidership, maxRidership)
